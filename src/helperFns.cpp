...
int stuff[] = {'#',
               static_cast<int>(ACS_ULCORNER),
               static_cast<int>(ACS_LLCORNER),
               static_cast<int>(ACS_URCORNER),
               static_cast<int>(ACS_LRCORNER),
               static_cast<int>(ACS_LTEE),
               static_cast<int>(ACS_RTEE),
               static_cast<int>(ACS_BTEE),
               static_cast<int>(ACS_TTEE),
               static_cast<int>(ACS_HLINE),
               static_cast<int>(ACS_VLINE),
               static_cast<int>(ACS_PLUS)};
...
bool isInside(int x, int y, std::string direction = "omni") {
    ...
    if (direction == "left") {
        ...
        return isInside(x + 1, y, "right") && isInside(x - 1, y, "left") && isInside(x, y - 1, "up") && isInside(x, y + 1, "down");
    }
}
